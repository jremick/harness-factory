...
| AC5 | Existing regression suites | pass | 144 pytest cases plus 3 subtests; 14 software-E2E tests |
...
| AC9 | Public-path and secret hygiene scan | pass | 250-file frozen publication projection; Gitleaks 8.30.1 found no leaks |
