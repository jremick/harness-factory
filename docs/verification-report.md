...
| --- | --- | --- |
| Pytest schema, semantic, HIR, installer, packaging and regression suite | pass | 136 tests plus 3 subtests |
...
| Public repository surface | pass | `tools/check_public_surface.py`, 253 candidate files; Gitleaks 8.30.1 found no leaks |
